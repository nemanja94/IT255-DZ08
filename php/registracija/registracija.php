    ...
    if (!empty($_POST)) {
        ...
        if ($valid) {
            ...
            try {
                ...
                $query = $pdo->prepare('SELECT metHotels.Korisnici.korisnik_email, metHotels.Korisnici.korisnik_lozinka
                ...
                if ($row_email['korisnik_email'] == $email) {
                    ...
                    $query = $pdo->prepare('INSERT INTO
                                                  metHotels.Korisnici(korisnik_fname, korisnik_lname, korisnik_email, korisnik_lozinka)
        ...
        <ul class="navbar-nav">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item" href="../prijava/prijava.php.">Prijava</a>
            </div>
          </li>
        </ul>
      </div>
